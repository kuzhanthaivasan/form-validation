...
function validateForm() {
    ...
    let mobile = document.contactForm.mobile.value;  // Corrected from document.contactForm.email.value
    let country = document.contactForm.country.value;
    let gender = document.contactForm.gender.value;
    let hobbies = [];
    let checkboxes = document.getElementsByName("hobbies[]"); // Corrected 'checkboxs' to 'checkboxes'
